...
rebuild_firmware() {
    ...
    my_packages="\
        luci-theme-bootstrap dnsmasq-full cgi-io liblua liblucihttp liblucihttp-lua libubus-lua lua luci \ 
        luci-app-firewall luci luci-app-opkg luci-base luci-lib-base luci-lib-ip luci-lib-jsonc luci-lib-nixio \
        ...
        luci-app-amlogic luci-app-diskman luci-compat luci-lib-ipkg luci-proto-ipip \
        \
        luci-mod-status luci-mod-system luci-proto-3g luci-proto-ncm luci-proto-qmi luci-proto-relay \
        \
